...
urlpatterns = [
   ...
   path('create/', include('markdownx.urls')),
   path('create/', CreatePost.as_view(), name='create'),
   path('update/', include('markdownx.urls')), 
   ...
   path('comment-create/', include('markdownx.urls')), 
   path('comment-create/<int:pk>/', CreateComment.as_view(), name='comment-create'),
   path('comment-update/', include('markdownx.urls')),  
